...
sudo cp /home/pi/pysoc/premade-config/config_elze.ini /home/pi/config.ini &&
sudo cp /home/pi/pysoc/premade-config/config_elze.ini /home/pi/pysoc/config.ini &&
sudo cp /home/pi/pysoc/premade-config/config_elze.ini /home/pi/pysoc/dist/config.ini &&
