...
sudo cp /home/pi/pysoc/premade-config/config_khiet.ini /bin/config.ini &&
sudo cp /home/pi/pysoc/premade-config/config_khiet.ini /home/pi/config.ini &&
sudo cp /home/pi/pysoc/premade-config/config_khiet.ini /home/pi/pysoc/config.ini &&
sudo cp /home/pi/pysoc/premade-config/config_khiet.ini /home/pi/pysoc/dist/config.ini &&
